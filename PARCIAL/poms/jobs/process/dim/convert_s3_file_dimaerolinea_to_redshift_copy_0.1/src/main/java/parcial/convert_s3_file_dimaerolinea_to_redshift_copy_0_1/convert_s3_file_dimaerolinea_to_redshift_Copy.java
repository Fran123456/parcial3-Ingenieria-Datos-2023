...
package parcial.convert_s3_file_dimaerolinea_to_redshift_copy_0_1;
...
/**
 * Job: convert_s3_file_dimaerolinea_to_redshift_Copy Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class convert_s3_file_dimaerolinea_to_redshift_Copy implements TalendJob {
	...
	private final String jobName = "convert_s3_file_dimaerolinea_to_redshift_Copy";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					convert_s3_file_dimaerolinea_to_redshift_Copy.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(convert_s3_file_dimaerolinea_to_redshift_Copy.this,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:yOsFK1ImcWZpnBWKcm2lMqjBqdVg+OeuZNoZY+r/U4Xk736UiquK");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:KOqaBn7UBvMHSqVPrW7R7HLhz1zc0OUEjq95gwTFyA==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:f4H2qPTPLKeEV+en2zRZ8tcyhQTOJ9SHkG1I3aaDIKjJXfP/L7ZItYV05iB6/6Miq/Oge7gJjwIHtW4mcgduztpCPyI=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"parcial-especializacion", "Airlines.csv");

					com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
							getObjectRequest_tS3Get_1,
							new java.io.File("G:/ues-parcial/archive/raw/out/Airlines-actual.csv"), null, 0l, true);
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_PARCIAL_convert_s3_file_dimaerolinea_to_redshift_Copy = new byte[0];
		static byte[] commonByteArray_PARCIAL_convert_s3_file_dimaerolinea_to_redshift_Copy = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PARCIAL_convert_s3_file_dimaerolinea_to_redshift_Copy.length) {
					if (length < 1024
							&& commonByteArray_PARCIAL_convert_s3_file_dimaerolinea_to_redshift_Copy.length == 0) {
						commonByteArray_PARCIAL_convert_s3_file_dimaerolinea_to_redshift_Copy = new byte[1024];
					} else {
						commonByteArray_PARCIAL_convert_s3_file_dimaerolinea_to_redshift_Copy = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PARCIAL_convert_s3_file_dimaerolinea_to_redshift_Copy, 0, length);
				strReturn = new String(commonByteArray_PARCIAL_convert_s3_file_dimaerolinea_to_redshift_Copy, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PARCIAL_convert_s3_file_dimaerolinea_to_redshift_Copy, 0,
						length);
				strReturn = new String(commonByteArray_PARCIAL_convert_s3_file_dimaerolinea_to_redshift_Copy, 0, length,
						utf8Charset);
			}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PARCIAL_convert_s3_file_dimaerolinea_to_redshift_Copy) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "dimaerolinea";
				...
				class BufferLine_tDBOutput_1 {
					...
					public BufferLine_tDBOutput_1 c0(Integer Id) {
						this.Id = Id;
						return this;
					}
					...
					public BufferLine_tDBOutput_1 c1(String Code) {
						this.Code = Code;
						return this;
					}
					...
					public BufferLine_tDBOutput_1 c2(String Description) {
				...
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"id\",\"codigo\",\"aerolinea\") VALUES " + extendInsertValueStmt_tDBOutput_1.toString();
				...
				String tableName_tDBOutput_2 = "aerolinea";
				...
				java.sql.ResultSet rsTable_tDBOutput_2 = dbMetaData_tDBOutput_2.getTables("parcial", null, null,
						new String[] { "TABLE" });
				boolean whetherExist_tDBOutput_2 = false;
				while (rsTable_tDBOutput_2.next()) {
					String table_tDBOutput_2 = rsTable_tDBOutput_2.getString("TABLE_NAME");
					if (table_tDBOutput_2.equalsIgnoreCase("aerolinea")) {
				...
				try (java.sql.Statement stmtCreate_tDBOutput_2 = conn_tDBOutput_2.createStatement()) {
					stmtCreate_tDBOutput_2.execute("CREATE TABLE `" + tableName_tDBOutput_2
							+ "`(`id` INT(0)  ,`codigo` VARCHAR(10)  ,`aerolinea` VARCHAR(100)  )");
				}

				String insert_tDBOutput_2 = "INSERT INTO `" + "aerolinea"
						+ "` (`id`,`codigo`,`aerolinea`) VALUES (?,?,?)";
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "G:/ues-parcial/archive/raw/out/Airlines-actual.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"G:/ues-parcial/archive/raw/out/Airlines-actual.csv", "US-ASCII", ",", "\n", false, 1,
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (row1.Code == null) {
								...
								pstmt_tDBOutput_2.setString(2, row1.Code);
							}

							if (row1.Description == null) {
								pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(3, row1.Description);
							}
...
// Start of branch "row2"
							if (row2 != null) {
								...
								if (row2.Id == null) {
									...
									pstmt_tDBOutput_1.setInt(countertDBOutput_1, row2.Id);
								...
								if (row2.Code == null) {
									...
									pstmt_tDBOutput_1.setString(countertDBOutput_1, row2.Code);
								...
								if (row2.Description == null) {
									...
									pstmt_tDBOutput_1.setString(countertDBOutput_1, row2.Description);
								...
								exInsertColValuetDBOutput_1
										...
										.c0(row2.Id).c1(row2.Code).c2(row2.Description);
					...
					if (!((Object) ("G:/ues-parcial/archive/raw/out/Airlines-actual.csv") instanceof java.io.InputStream)) {
				...
				if (rowCounttDBOutput_1 != 0) {
					...
					insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
							+ "\" (\"id\",\"codigo\",\"aerolinea\") VALUES " + extendInsertValue_tDBOutput_1.toString();
					...
					for (BufferLine_tDBOutput_1 bufferLtDBOutput_1 : exInsertColValueListtDBOutput_1) {
						...
						if (bufferLtDBOutput_1.Id == null) {
							pstmt_tDBOutput_1.setNull(counttDBOutput_1, java.sql.Types.INTEGER);

						} else {

							pstmt_tDBOutput_1.setInt(counttDBOutput_1, bufferLtDBOutput_1.Id);
						...
						if (bufferLtDBOutput_1.Code == null) {
							...
							pstmt_tDBOutput_1.setString(counttDBOutput_1, bufferLtDBOutput_1.Code);

						}

						counttDBOutput_1++;

						if (bufferLtDBOutput_1.Description == null) {
							pstmt_tDBOutput_1.setNull(counttDBOutput_1, java.sql.Types.VARCHAR);

						} else {

							pstmt_tDBOutput_1.setString(counttDBOutput_1, bufferLtDBOutput_1.Description);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.PrintWriter fileLogWriter_tDBClose_1 = (java.io.PrintWriter) globalMap
						.get("fileLogWriter_tDBConnection_1");
	...
	public static void main(String[] args) {
		final convert_s3_file_dimaerolinea_to_redshift_Copy convert_s3_file_dimaerolinea_to_redshift_CopyClass = new convert_s3_file_dimaerolinea_to_redshift_Copy();

		int exitCode = convert_s3_file_dimaerolinea_to_redshift_CopyClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = convert_s3_file_dimaerolinea_to_redshift_Copy.class.getClassLoader()
					.getResourceAsStream("parcial/convert_s3_file_dimaerolinea_to_redshift_copy_0_1/contexts/"
							+ contextStr + ".properties");
			if (inContext == null) {
				inContext = convert_s3_file_dimaerolinea_to_redshift_Copy.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : convert_s3_file_dimaerolinea_to_redshift_Copy");
		}
...
/************************************************************************************************
 * 92879 characters generated by Talend Open Studio for Data Integration on the
 * 29 October 2023 at 14:44:23 GMT-06:00
 ************************************************************************************************/